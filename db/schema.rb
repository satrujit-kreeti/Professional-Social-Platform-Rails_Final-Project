...
ActiveRecord::Schema.define(version: 2023_08_21_073056) do
  ...
  create_table "job_requirements", force: :cascade do |t|
    ...
    t.string "skills_required", null: false
    t.bigint "job_sector_id", null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "experience", default: "fresher"
    t.string "current_organization", default: ""
    t.string "skills"
